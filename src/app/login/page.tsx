    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 font-bold text-2xl mb-2 text-white drop-shadow-lg">
            <Building2 className="h-8 w-8" />
            <span>ClickStay</span>
          </Link>
          <p className="text-white text-lg font-medium drop-shadow-md">Sign In to Manage the Resort</p>
        </div>
